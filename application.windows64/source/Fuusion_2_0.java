...
public class Fuusion_2_0 extends PApplet {
...
public void menu(){
  ...
  int coul_souris = get(mouseX,mouseY);
...
public void gestionbobby() {
 ...
 public void gestion_yeux(){                                   //Selon la touche qui est enfonc\u00e9e, les yeux regardent dans cette direction
   if(bas == 1) {
...
public void plateforme_matrice (int x_ini, int y_ini, int longueur, int hauteur) {          // longueur et hauteur en bloc
...
public void matrice_pic (int x_ini, int y_ini, int longueur) {    // longueur des pic en bloc de 50x50                    // Cr\u00e9er les pics dans la matrice  ----  /!\ Les coordonn\u00e9es des pics sont ceux en bas \u00e0 gauche !!!!!!!!!!!!!!!!!!!!!!!!!!!
  int i ;                                                          
...
public void matrice_pic_plaf (int x_ini, int y_ini, int longueur) {    // /!\ Les coordonn\u00e9es des pics sont ceux en haut \u00e0 gauche !!!!!!!!!!!!!!!!!!!!!!!!!!!
  int i ;                                                          
  int j ;                                             
...
public void declenchement_pause(){
...
public void decors(){ 
  ...
  if(droite == 1 && collision_d == 0){                         //Si on appuie sur la fleche de droite
    vent = 0.5f;                            //alors la vitesse des nuages est de 0.5
  ...
  if((gauche !=1 && droite !=1) || (gauche == 1 && droite ==1) || (gauche == 1 && collision_g != 0) || (droite == 1 && collision_d != 0)){            //Si bobby ne bouge pas
   vent = 0.5f;                             //alors le vent est egal \u00e0 0.5
  }
  ...
  if(xn1>900){                            //Si le nuage 1 est dans la partie droite de l'ecran (>900)
   yn1 = yn1 - 0.05f;                      //alors il monte doucement
  } else{                                 //Sinon
   yn1 = yn1 + 0.05f;                      //il descend doucement
  }
  
  if(xn2>700){                            //Si le nuage 2 est dans la partie droite de l'ecran (>700)
   yn2 = yn2 - 0.05f;                      //alors il monte doucement
  } else{                                 //Sinon
   yn2 = yn2 + 0.05f;                      //il descend doucement
  }
}
...
public void init_niv1(){               //Reinitialisation des variables utiles au fonctionnement du premier niveau
...
public void stop() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Fuusion_2_0" };
    if (passedArgs != null) {
